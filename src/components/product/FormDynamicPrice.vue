<template>
  <a-form ref="formRef" :model="dynamicValidateForm" name="dynamic_form_item" v-bind="formItemLayoutWithOutLabel">
    ...
    >
      <a-input v-model:value="classData.value" style="width: 90%; margin-right: 8px" />
      <i
    ...
    <a-form-item v-if="dynamicValidateForm.dataClass.length <= 15" v-bind="formItemLayoutWithOutLabel">
